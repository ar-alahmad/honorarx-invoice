 ...
 * Creates a grid of particles with configurable scale
 */
function getPlane(
  count: number,
  components: number,
...
/**
 * SimulationMaterial - GPU-based particle position calculation
 * Uses periodic noise for organic, looping animations
 */
